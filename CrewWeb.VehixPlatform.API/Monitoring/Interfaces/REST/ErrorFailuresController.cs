...
[ApiController]
[Route("api/v1/errors/{errorId:int}/failures")]
...
public class ErrorFailuresController(IFailureQueryService failureQueryService):ControllerBase
{
    ...
    [SwaggerResponse(StatusCodes.Status200OK, "List of tutorials", typeof(IEnumerable<FailureResource>))]
    public async Task<IActionResult> GetFailuresByErrorType(string errorType)
    {
        ...
        var tutorialResources = failures
